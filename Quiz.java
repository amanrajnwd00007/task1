...
public class Quiz extends JFrame implements ActionListener {
  ...
  Quiz() {
    ...
    quo = new JLabel();
    quo.setBounds(100, 450, 50, 30);
    quo.setFont(new Font("Tahoma", Font.PLAIN, 24));
    add(quo);

    question = new JLabel();
    question.setBounds(150, 450, 990, 30);
    ...
    opt1.setFont(new Font("Digital", Font.PLAIN, 20));
    add(opt1);

    opt2 = new JRadioButton();
    opt2.setBounds(170, 560, 700, 30);
    opt2.setBackground(Color.WHITE);
    opt2.setFont(new Font("Digital", Font.PLAIN, 20));
    add(opt2);

    opt3 = new JRadioButton();
    opt3.setBounds(170, 600, 700, 30);
    opt3.setBackground(Color.WHITE);
    opt3.setFont(new Font("Digital", Font.PLAIN, 20));
    add(opt3);

    opt4 = new JRadioButton();
    opt4.setBounds(170, 640, 700, 30);
    opt4.setBackground(Color.WHITE);
    opt4.setFont(new Font("Digital", Font.PLAIN, 20));
    add(opt4);
...
countdownTimer = new Timer(1000, new ActionListener() {
  ...
  public void actionPerformed(ActionEvent e) {
      if (timer > 0) {
          timer--;
          repaint();  // Repaint to update the timer label
      } else {
...
// Handle the logic for submitting the quiz, showing results, etc.
// For example, calculate the score and display it.
